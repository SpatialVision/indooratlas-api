 ...
 * https://api.indooratlas.com/venues/8a7d0582-9a2b-4b24-9e62-5c961e2b993e
 */
/**
...
describe('IndoorAtlas API', function() {
  ...
  describe('Atlas Venues', function() {
    describe('User Venue', function(done) {
      var path = 'venues/8a7d0582-9a2b-4b24-9e62-5c961e2b993e';
      it('should receive SV venue with floor plans: ' + path, function(done) {
        ...
        atlas.api(path, function(err, data) {
          ...
          var file = 'results/user-venue.json';
