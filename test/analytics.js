 ...
 * https://api.indooratlas.com/floorplans/2559951f-8470-46c1-8d32-2983e6636d71/analytics
 */
...
describe('IndoorAtlas API', function() {
  ...
  describe('Atlas Venues', function() {
    describe('Floor analytics', function(done) {
      var path = 'floorplans/2559951f-8470-46c1-8d32-2983e6636d71/analytics';
      it('should receive SV venue with floor plans: ' + path, function(done) {

        atlas.api(path, function(err, data) {
          expect(err).to.not.exist;
          expect(data).to.be.instanceof(Object);
          var out = JSON.stringify(data,null,2);
          var file = 'results/floorplans-analytics.json';
